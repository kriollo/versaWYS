...
<template>
    <div>
        <ul
            ...
            <li v-for="(item, key) in data" :key="item.id" class="flex justify-between items-center" :class="key === item.length - 1
                ? 'rounded-b-lg'
                ...
                <div class="flex gap-2">
                    ...
                    <button type="button" class="text-xs" :class="item.estado === '0'
