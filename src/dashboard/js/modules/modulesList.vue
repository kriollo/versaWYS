...
<template>
    <div>
        <customTable id="modulesTable" :externalFilters="externalFilters" :refreshData="refreshTable" @accion="accion"
            fieldOrder="seccion" tablaTitle="Listado de Modulos de la Aplicación"
        ...
        <listSubModules :showModal="showModalSubMenu" @accion="accion" :idModule="Number(idModuleSelected)" />
    </div>
</template>
