...
<template>
    <modal :idModal="origen + 'resetPass'" :showModal="showModalLocal" @accion="accion">
        ...
        <template v-slot:modalBody>
            <form id="formChangePass" class="space-y-4">
                ...
                <div class="relative">
                    ...
                    <span id="togglePasswordNew" class="absolute end-0 flex items-center cursor-pointer pr-2 top-[60%]"
                        @click="
                            tooglePassword(
                                'new_password',
                                'imgShowPassNew',
                            ...
                            ">
                        <svg id="imgShowPassNew" class="hidden w-6 h-6 text-gray-800 dark:text-slate-400" fill="none"
                            viewbox="0 0 20 18" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M1.933 10.909A4.357 4.357 0 0 1 1 9c0-1 4-6 9-6m7.6 3.8A5.068 5.068 0 0 1 19 9c0 1-3 6-9 6-.314 0-.62-.014-.918-.04M2 17 18 1m-5 8a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"
                                stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                        </svg>
                        <svg id="imgHiddenPassNew" class="show w-6 h-6 text-gray-800 dark:text-slate-400" fill="none"
                ...
                <div class="relative">
                    ...
                    <span id="togglePasswordConfirmNew"
                        class="absolute end-0 flex items-center cursor-pointer pr-2 top-[60%]" @click="
                            tooglePassword(
                            ...
                            ">
                        <svg id="imgShowPassConfirmNew" class="hidden w-6 h-6 text-gray-800 dark:text-slate-400"
                            fill="none" viewbox="0 0 20 14" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M1.933 10.909A4.357 4.357 0 0 1 1 9c0-1 4-6 9-6m7.6 3.8A5.068 5.068 0 0 1 19 9c0 1-3 6-9 6-.314 0-.62-.014-.918-.04M2 17 18 1m-5 8a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"
                                stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                        </svg>
                        <svg id="imgHiddenPassConfirmNew" class="show w-6 h-6 text-gray-800 dark:text-slate-400"
                            fill="none" viewbox="0 0 20 14" xmlns="http://www.w3.org/2000/svg">
                            <g stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                                <path d="M10 10a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" />
                                <path d="M10 13c4.97 0 9-2.686 9-6s-4.03-6-9-6-9 2.686-9 6 4.03 6 9 6Z" />
                    ...
                    <input id="comfirm_new_password" type="password"
                        class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        name="comfirm_new_password" placeholder="••••••••" required />
                </div>
            </form>
        </template>
