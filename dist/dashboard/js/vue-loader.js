...
import { createApp, provide, ref } from '/node_modules/vue/dist/vue.esm-browser.js';
...
const loadModule = async () => {
    const $contenedor = $dom('#main-content');
    ...
    try {
        ...
        const component = validatedModule.split('/').pop();
        if (!component) {
        ...
        if (moduleResponse) {
            ...
            // Configuración de la aplicación según el modo de depuración
            if (debug) {
                app.config.warnHandler = function warnHandler(msg, vm, trace) {
