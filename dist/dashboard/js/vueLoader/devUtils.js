...
const handleHMRError = (errorMessage, trace) => {
    ...
    if (!ErrorContainer) {
        ...
        ErrorContainer.classList.add('fixed', 'top-0', 'left-0', 'right-0', 'z-50');
